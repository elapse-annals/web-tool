@extends('arrays._layout')

@section('content')
    <div class="search">
        @include('arrays._search')
    </div>
    <div class="stripe">
        @include('arrays._stripe')
    </div>
    <div class="table">
        @include('arrays._list')
    </div>
    <div class="page">
        @include('arrays._page')
    </div>
@endsection
    ...
    <script>
        ...
        var mixin = {
            ...
            methods: {
                ...
                alertThis(array_this) {
                    console.log(array_this)
                },
                deleteRow(id) {
                    axios.delete('/arrays/' + id)
                        .then(
                            (response) => {
                ...
                reload() {
                    ...
                    axios.get('/arrays/', {params: request_parameter})
                        .then((response) => {
